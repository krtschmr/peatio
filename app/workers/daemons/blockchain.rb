  ...
  module Daemons
    class Blockchain < Base
      ...
      def process(bc)
        ...
        while running
          begin
            bc_service.fetch_current_height

            if bc.reload.height + bc.min_confirmations >= bc_service.current_height
              logger.info { "Skip synchronization. No new blocks detected, height: #{bc.height}, latest_block: #{bc_service.current_height}." }
            ...
            (from_block..bc_service.current_height).each do |block_id|
